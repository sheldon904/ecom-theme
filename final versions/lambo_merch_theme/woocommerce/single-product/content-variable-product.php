                ...
                <div class="wishlist-button">
                    ...
                    ?>
                        ...
                        jQuery(document).ready(function($) {
                            console.log('Variable product: Add to Wishlist button loaded for product ID:', <?php echo $product_id; ?>);
                            
                            // Add direct event listener for this specific button
                            $('.wishlist-button .add-to-wishlist').on('click', function(e) {
                                e.preventDefault();
                                console.log('Variable product: Wishlist button clicked directly!');
